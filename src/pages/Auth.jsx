        ...
        <div className="flex flex-col md:flex-row gap-3 items-center">
          <div className="input-container">
            <form className="w-full md:w-[480px] flex flex-col space-y-4" onSubmit={variant === 'login' ? loginUser : registerUser}>
              {variant === 'register' && <Input label={'Username'} type={'text'} value={username} onChange={(e) => setUsername(e.target.value)} />}
  ...
  {loading ? (
    ...
    variant === 'login' ? 'Login' : 'Register'
              ...
              <p className="text-black mt-12">
                ...
                <span onClick={toggleVariant} className="text-[#567df4] ml-1 hover:underline cursor-pointer">
